...
class WebViewerPage extends StatelessWidget {
  WebViewerPage({Key key, this.tn, this.newsModel}) : super(key: key);
  // WebViewerPage({Key key, this.id, this.title, this.url, this.ot}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    print('@@@ WebViewerPage => newsModel : ${newsModel.toJsonStr()}');
    return Scaffold(
      appBar: AppBar(
      ...
      body: Builder(builder: (BuildContext context) {
        return WebView(
          ...
          //   if (request.url.startsWith('https://www.163.com/')) {
  ...
  void _setFavorite() {
    DataHelpr.dataHandler('Favorites/Add', {"id": newsModel.id, "tn": tn},
        (rm) {
